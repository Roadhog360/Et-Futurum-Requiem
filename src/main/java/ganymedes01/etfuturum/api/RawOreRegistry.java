...
public class RawOreRegistry {
	...
	public static final Map<String, RawOreDropMapping> rawOreRegistry = new Object2ObjectOpenHashMap<>();
	...
	public static void addOre(String oreDict, Item ore, int meta) {
		if (RecipeHelper.validateItems(ore)) {
			addOre(oreDict, new RawOreDropMapping(ore, meta, ArrayUtils.contains(ConfigFunctions.extraDropRawOres, oreDict)));
		}
	}

	public static void addOre(String oreDict, RawOreDropMapping map) {
