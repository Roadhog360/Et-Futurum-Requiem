...
public class BackhandSwapPacket extends BackhandBasePacket {
    ...
    public void process(ByteBuf inputStream, EntityPlayer player) {
        ...
        if (this.player != null) {
            ItemStack offhandItem = ganymedes01.etfuturum.backhand.Backhand.INSTANCE.getOffhandItem(this.player);
            if (ganymedes01.etfuturum.backhand.Backhand.INSTANCE.isOffhandBlacklisted(player.getCurrentEquippedItem()) || ganymedes01.etfuturum.backhand.Backhand.INSTANCE.isOffhandBlacklisted(offhandItem))
                return;

                ganymedes01.etfuturum.backhand.Backhand.INSTANCE.setPlayerOffhandItem(this.player,this.player.getCurrentEquippedItem());
            ganymedes01.etfuturum.backhand.Backhand.setPlayerCurrentItem(this.player,offhandItem);
